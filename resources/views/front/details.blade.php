    ...
    <div class="relative flex flex-col w-full min-h-screen max-w-[640px] mx-auto bg-white">
        ...
        <main id="details" class="flex flex-col gap-5 px-4 pb-[116px]">
            <section id="Get-to-Know" class="flex flex-col gap-[6px]">
                <h2 class="font-bold text-sm leading--[21px]">Tentang Tempat</h2>
            ...
            <section id="Travel-with-Juara" class="flex flex-col gap-[6px]">
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div class="flex flex-col items-center rounded-3xl p-[14px_16px] gap-3 text-center bg-[#13181D]">
                        ...
                        <div>
                            <h3 class="font-bold text-sm leading-[21px] text-white">Keamanan</h3>
                            <p class="text-xs leading-[18px] text-white">100% Aman</p>
                        </div>
                    </div>
                    <div class="flex flex-col items-center rounded-3xl p-[14px_16px] gap-3 text-center bg-[#13181D]">
                        <img src="{{asset('assets/images/icons/hospital.svg')}}" class="w-9 h-9" alt="icon">
                        <div>
                            <h3 class="font-bold text-sm leading-[21px] text-white">Asuransi</h3>
                            <p class="text-xs leading-[18px] text-white">Tersedia</p>
                        </div>
                    </div>
                    <div class="flex flex-col items-center rounded-3xl p-[14px_16px] gap-3 text-center bg-[#13181D]">
                        <img src="{{asset('assets/images/icons/lovely.svg')}}" class="w-9 h-9" alt="icon">
                        <div>
                            <h3 class="font-bold text-sm leading-[21px] text-white">Kenyamanan</h3>
                            <p class="text-xs leading-[18px] text-white">100% Mudah digunakan</p>
                        </div>
                    </div>
                </div>
            </section>
            <section id="Management" class="flex flex-col gap-[6px]">
                <h2 class="font-bold text-sm leading--[21px]">Manajemen</h2>
                <div class="flex items-center justify-between rounded-3xl p-[10px] pr-[14px] bg-[#F8F8F9]">
                    <div class="flex items-center gap-[14px]">
                        ...
                        <div>
                            ...
                            <p class="text-sm leading-[21px]">{{$ticket->seller->tickets->count()}} Tempat</p>
                        </div>
                    </div>
                    <a href="https://wa.me/{{$ticket->seller->telephone}}" target="_blank">
                        <img src="{{ asset('assets/images/icons/call-orange.svg') }}" class="w-10 h-10" alt="Whatsapp Call">
                    </a>
                </div>
            </section>
            <section id="Map" class="flex flex-col gap-[10px]">
                <h2 class="font-bold text-sm leading--[21px]">Map & Alamat</h2>
