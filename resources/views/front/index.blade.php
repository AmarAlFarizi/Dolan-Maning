                        ...
                        <div class="swiper-slide !w-fit">
                            <a href="{{ route('front.details', $itemPopularTicket->slug) }}" class="card">
                                <div class="relative flex items-end w-[345px] h-[220px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                                    <img src="{{isset($itemPopularTicket->thumbnail) ? $itemPopularTicket->thumbnail : 'assets/images/thumbnails/thumbnail-1.png'}}" class="absolute w-full h-full object-cover" alt="thumbnail">
                        ...
                        <div class="swiper-slide !w-fit">
                            <a href="{{route('front.seller', $itemSeller->slug)}}" class="card">
                                <div class="relative flex items-end w-[170px] h-[200px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                                    <img src="{{isset($itemSeller->photo)  ? $itemSeller->photo: 'assets/images/thumbnails/thumbnail-4.png'}}" class="absolute w-full h-full object-cover" alt="thumbnail">
                                    <div class="flex flex-col items-start justify-between w-full h-fit rounded-[17px] border border-white/40 p-[8px_10px] mx-[10px] mb-[10px] bg-[#94959966] backdrop-blur-sm">
                                        <div>
                                            <h3 class="font-bold text-white text-base sm:text-sm leading-tight break-words">
                                                {{$itemSeller->name}}
                                            </h3>
                                            <p class="text-sm leading-[18px] text-white">
                                                {{$itemSeller->tickets->count()}} Tempat
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="flex items-center justify-between rounded-3xl p-[6px] pr-[14px] bg-white overflow-hidden">
                            <div class="flex items-center gap-[14px]">
                                <div class="flex w-[90px] h-[90px] shrink-0 rounded-3xl bg-[#D9D9D9] overflow-hidden">
                                    <img src="{{isset($itemNewTicket->thumbnail)  ? $itemNewTicket->thumbnail: 'assets/images/thumbnails/thumbnail-7.png'}}" class="w-full h-full object-cover" alt="thumbnail">
                                </div>
                                <div class="flex flex-col gap-[6px]">
                                    ...
                                    <div class="flex items-center gap-1">
                                        ...
                                        <p class="font-semibold text-xs leading-[18px]">
                                            {{$itemNewTicket->address}}
                                        </p>
                                    </div>
                                    <p class="font-bold text-sm leading-[21px] text-[#F97316]">Rp
                                        {{number_format($itemNewTicket->price,0, ',','.')}}
                                    </p>
                                </div>
                            </div>
